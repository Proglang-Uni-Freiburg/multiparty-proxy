...
from src.scribble.visit.visitor import Visitor as Visitor

from src.scribble.ast_scribble.importmodule import traverse as importmodule_traverse 
# TODO: import members
from src.scribble.ast_scribble.module import traverse as module_traverse
from src.scribble.ast_scribble.moduledecl import traverse as moduledecl_traverse
from src.scribble.ast_scribble.parameterdecllist import traverse as parameterdecllist_traverse
from src.scribble.ast_scribble.payloadtypedecl import traverse as payloadtypedecl_traverse
from src.scribble.ast_scribble.roledecllist import traverse as roledecllist_traverse
from src.scribble.ast_scribble.roleinstantiationlist import \
    traverse as roleinstantiationlist_traverse
from src.scribble.ast_scribble.roleinstantiation import traverse as roleinstantiation_traverse
from src.scribble.ast_scribble.argumentlist import traverse as argumentlist_traverse
from src.scribble.ast_scribble.argument import traverse as argument_traverse
from src.scribble.ast_scribble.messagesignature import traverse as messagesignature_traverse
from src.scribble.ast_scribble.payload import traverse as payload_traverse
from src.scribble.ast_scribble.payloadelement import traverse as payloadelement_traverse
...
from src.scribble.ast_scribble.globel.globalinteractionsequence import \
...
from src.scribble.ast_scribble.globel.globalchoice import traverse as globalchoice_traverse
from src.scribble.ast_scribble.globel.globalrecursion import traverse as globalrecursion_traverse
from src.scribble.ast_scribble.globel.globalcontinue import traverse as globalcontinue_traverse
from src.scribble.ast_scribble.globel.globalparallel import traverse as globalparallel_traverse
from src.scribble.ast_scribble.globel.globalinterruptible import \
    traverse as globalinterruptible_traverse
from src.scribble.ast_scribble.globel.globalinterrupt import traverse as globalinterrupt_traverse
from src.scribble.ast_scribble.globel.globaldo import traverse as globaldo_traverse

from src.scribble.ast_scribble.local.localprotocoldecl import \
    traverse as localprotocoldecl_traverse
from src.scribble.ast_scribble.local.localprotocoldef import \
    traverse as localprotocoldef_traverse
from src.scribble.ast_scribble.local.localprotocolblock import \
    traverse as localprotocolblock_traverse
from src.scribble.ast_scribble.local.localinteractionsequence import \
    traverse as localinteractionsequence_traverse
from src.scribble.ast_scribble.local.localsend import traverse as localsend_traverse
from src.scribble.ast_scribble.local.localreceive import traverse as localreceive_traverse
from src.scribble.ast_scribble.local.localchoice import traverse as localchoice_traverse
from src.scribble.ast_scribble.local.localrecursion import traverse as localrecursion_traverse
from src.scribble.ast_scribble.local.localcontinue import traverse as localcontinue_traverse
from src.scribble.ast_scribble.local.localparallel import traverse as localparallel_traverse
from src.scribble.ast_scribble.local.localinterruptible import \
    traverse as localinterruptible_traverse
from src.scribble.ast_scribble.local.localthrow import traverse as localthrow_traverse
from src.scribble.ast_scribble.local.localcatch import traverse as localcatch_traverse
from src.scribble.ast_scribble.local.localdo import traverse as localdo_traverse
