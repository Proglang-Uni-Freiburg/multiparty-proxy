...
from src.scribble.namesubstitutor import NameSubstitutor as NameSubstitutor
...
from src.scribble.visit.traverser import Traverser as Traverser

from src.scribble.ast_scribble.module import get_full_name as module_get_full_name
