...
from src.scribble.ast_scribble.local.localnode import LocalNode as LocalNode

from src.scribble.ast_scribble.local.localprotocolblock import \
    pretty_print as localprotocolblock_pretty_print
from src.scribble.ast_scribble.local.localthrow import pretty_print as localthrow_pretty_print
from src.scribble.ast_scribble.local.localcatch import pretty_print as localcatch_pretty_print
