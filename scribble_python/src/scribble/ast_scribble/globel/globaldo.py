...
from src.scribble.namesubstitutor import NameSubstitutor

from src.scribble.ast_scribble.argumentlist import (
...
from src.scribble.ast_scribble.module import get_moduledecl_child as module_get_moduledecl_child
from src.scribble.ast_scribble.moduledecl import get_full_name as moduledecl_get_full_name
from src.scribble.ast_scribble.roledecl import get_role_name as roledecl_get_role_name
from src.scribble.ast_scribble.roledecllist import \
    get_roledecl_children as roledecllist_get_roledecl_children

from src.scribble.ast_scribble.roleinstantiation import (
...
from src.scribble.ast_scribble.argument import (
...
def context_visitor_enter(cv, node_):
    ...
    if fullname in list(do_frame.keys()):
...
def check_wellformedness_enter(checker, node_):
    ...
    if target not in list(globals.keys()):
